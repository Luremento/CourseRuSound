...
@section('content')
                                    ...
                                    <label for="track"
                                        ...
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                            ...
                                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                                    class="font-semibold">Выберите трек</span></p>
                                            <p id="track-file-name"
                                                class="mt-2 text-sm text-gray-500 dark:text-gray-400 hidden"></p>
                                        </div>
                                        <input id="track" name="track" type="file" class="hidden"
                                            onchange="displayTrackFileName(this)" />
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="cover"
                                        ...
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                            ...
                                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                                    class="font-semibold">Выберите обложку</span></p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, JPEG, WEBP</p>
                                            <p id="file-name" class="mt-2 text-sm text-gray-500 dark:text-gray-400 hidden">
                                            </p>
                                        </div>
    ...
    <script>
        ...
        function displayTrackFileName(input) {
            const fileNameElement = document.getElementById('track-file-name');
            if (input.files && input.files[0]) {
                fileNameElement.textContent = input.files[0].name;
                fileNameElement.classList.remove('hidden');
            } else {
